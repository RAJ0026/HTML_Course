...
/* ============================================================
   Amazon Halo Modal (Sprint 18)
   ============================================================ */
function initHaloModal() {
  const modal = $('#halo-modal');
  const overlay = $('#halo-overlay');
  const closeBtn = $('#halo-close');
  const shopBtn = $('#shop-halo');
  ...
  window.openHalo = openHalo;
  
  closeBtn?.addEventListener('click', closeHalo);
  overlay?.addEventListener('click', closeHalo);
  
  shopBtn?.addEventListener('click', () => {
    if (window.showToast) {
      showToast('Redirecting to Amazon Halo...');
    }
    setTimeout(closeHalo, 1000);
  });
}
...
/* ============================================================
   Amazon One Modal (Sprint 18)
   ============================================================ */
function initOneModal() {
  const modal = $('#one-modal');
  const overlay = $('#one-overlay');
  const closeBtn = $('#one-close');
  const shopBtn = $('#shop-one');
  ...
  closeBtn?.addEventListener('click', closeOne);
  overlay?.addEventListener('click', closeOne);
  
  shopBtn?.addEventListener('click', () => {
    if (window.showToast) {
      showToast('Redirecting to Amazon One...');
    }
    setTimeout(closeOne, 1000);
  });
}
...
/* ============================================================
   Amazon Associates Modal (Sprint 20)
   ============================================================ */
function initAssociatesModal() {
  const modal = $('#associates-modal');
  const overlay = $('#associates-overlay');
  const closeBtn = $('#associates-close');
  const shopBtn = $('#shop-associates');
  ...
  function closeAssociates() {
    modal.classList.remove('show');
    overlay.classList.remove('show');
  }
  
  window.openAssociates = openAssociates;
  
  closeBtn?.addEventListener('click', closeAssociates);
  overlay?.addEventListener('click', closeAssociates);
  
  shopBtn?.addEventListener('click', () => {
    if (window.showToast) {
      showToast('Joining Amazon Associates...');
    }
    setTimeout(closeAssociates, 1000);
  });
}

/* ============================================================
   Amazon Seller Modal (Sprint 20)
   ============================================================ */
function initSellerModal() {
  const modal = $('#seller-modal');
  const overlay = $('#seller-overlay');
  const closeBtn = $('#seller-close');
  const shopBtn = $('#shop-seller');
  ...
  window.openSeller = openSeller;
  
  closeBtn?.addEventListener('click', closeSeller);
  overlay?.addEventListener('click', closeSeller);
  
  shopBtn?.addEventListener('click', () => {
    if (window.showToast) {
      showToast('Starting Amazon Seller journey...');
    }
    setTimeout(closeSeller, 1000);
  });
}
...
/* ============================================================
   Amazon Merch Modal (Sprint 20)
   ============================================================ */
function initMerchModal() {
  const modal = $('#merch-modal');
  const overlay = $('#merch-overlay');
  const closeBtn = $('#merch-close');
  const shopBtn = $('#shop-merch');
  ...
  closeBtn?.addEventListener('click', closeMerch);
  overlay?.addEventListener('click', closeMerch);
  
  shopBtn?.addEventListener('click', () => {
    if (window.showToast) {
      showToast('Starting Merch on Demand...');
    }
    setTimeout(closeMerch, 1000);
  });
}
...
/* ============================================================
   Amazon Games Modal (Sprint 22)
   ============================================================ */
function initGamesModal() {
  const modal = $('#games-modal');
  const overlay = $('#games-overlay');
  const closeBtn = $('#games-close');
  const shopBtn = $('#shop-games');
  ...
  overlay?.addEventListener('click', closeGames);
  
  shopBtn?.addEventListener('click', () => {
    if (window.showToast) {
      showToast('Redirecting to Amazon Games...');
    }
    setTimeout(closeGames, 1000);
  });
}

/* ============================================================
   Amazon Science Modal (Sprint 22)
   ============================================================ */
function initScienceModal() {
  const modal = $('#science-modal');
  const overlay = $('#science-overlay');
  const closeBtn = $('#science-close');
  const shopBtn = $('#shop-science');
  ...
  window.openScience = openScience;
  
  closeBtn?.addEventListener('click', closeScience);
  overlay?.addEventListener('click', closeScience);
  
  shopBtn?.addEventListener('click', () => {
    if (window.showToast) {
      showToast('Redirecting to Amazon Science...');
    }
    setTimeout(closeScience, 1000);
  });
}
...
/* ============================================================
   Amazon Global Selling Modal (Sprint 23)
   ============================================================ */
function initGlobalModal() {
  const modal = $('#global-modal');
  const overlay = $('#global-overlay');
  const closeBtn = $('#global-close');
  const shopBtn = $('#shop-global');
  ...
  closeBtn?.addEventListener('click', closeGlobal);
  overlay?.addEventListener('click', closeGlobal);
  
  shopBtn?.addEventListener('click', () => {
    if (window.showToast) {
      showToast('Redirecting to Amazon Global Selling...');
    }
    setTimeout(closeGlobal, 1000);
  });
}
...
/* ============================================================
   Amazon Custom Modal (Sprint 23)
   ============================================================ */
function initCustomModal() {
  const modal = $('#custom-modal');
  const overlay = $('#custom-overlay');
  const closeBtn = $('#custom-close');
  const shopBtn = $('#shop-custom');
  ...
  overlay?.addEventListener('click', closeCustom);
  
  shopBtn?.addEventListener('click', () => {
    if (window.showToast) {
      showToast('Redirecting to Amazon Custom...');
    }
    setTimeout(closeCustom, 1000);
  });
}
...
/* ============================================================
   Amazon Assistant Modal (Sprint 25)
   ============================================================ */
function initAssistantModal() {
  const modal = $('#assistant-modal');
  const overlay = $('#assistant-overlay');
  const closeBtn = $('#assistant-close');
  const shopBtn = $('#shop-assistant');
  ...
  shopBtn?.addEventListener('click', () => {
    if (window.showToast) {
      showToast('Redirecting to Amazon Assistant...');
    }
    setTimeout(closeAssistant, 1000);
  });
}
...
/* ============================================================
   Amazon Go Modal (Sprint 26)
   ============================================================ */
function initGoModal() {
  const modal = $('#go-modal');
  const overlay = $('#go-overlay');
  const closeBtn = $('#go-close');
  const shopBtn = $('#shop-go');
  ...
  closeBtn?.addEventListener('click', closeGo);
  overlay?.addEventListener('click', closeGo);
  
  shopBtn?.addEventListener('click', () => {
    if (window.showToast) {
      showToast('Redirecting to Amazon Go...');
    }
...
function initStyleModal() {
  ...
  window.openStyle = openStyle;
  
  closeBtn?.addEventListener('click', closeStyle);
  overlay?.addEventListener('click', closeStyle);
  
  shopBtn?.addEventListener('click', () => {
    if (window.showToast) {
      showToast('Redirecting to Amazon Style...');
    }
    setTimeout(closeStyle, 1000);
  });
}
...
/* ============================================================
   Blink Modal (Sprint 28)
   ============================================================ */
function initBlinkModal() {
  const modal = $('#blink-modal');
  const overlay = $('#blink-overlay');
  const closeBtn = $('#blink-close');
  const shopBtn = $('#shop-blink');
  ...
  window.openBlink = openBlink;
  
  closeBtn?.addEventListener('click', closeBlink);
  overlay?.addEventListener('click', closeBlink);
  
  shopBtn?.addEventListener('click', () => {
    if (window.showToast) {
      showToast('Redirecting to Blink...');
    }
    setTimeout(closeBlink, 1000);
  });
}
...
/* ============================================================
   Amazon Inspire Modal (Sprint 31)
   ============================================================ */
function initAmazonInspireModal() {
  const modal = $('#amazoninspire-modal');
  const overlay = $('#amazoninspire-overlay');
  const closeBtn = $('#amazoninspire-close');
  const shopBtn = $('#shop-amazoninspire');
  
  if (!modal || !overlay) return;
  
  function openAmazonInspire() {
    modal.classList.add('show');
    overlay.classList.add('show');
  }
  
  function closeAmazonInspire() {
    modal.classList.remove('show');
    overlay.classList.remove('show');
  }
  
  window.openAmazonInspire = openAmazonInspire;
  
  closeBtn?.addEventListener('click', closeAmazonInspire);
  overlay?.addEventListener('click', closeAmazonInspire);
  
  shopBtn?.addEventListener('click', () => {
    if (window.showToast) {
      showToast('Redirecting to Amazon Inspire...');
    }
    setTimeout(closeAmazonInspire, 1000);
  });
}
